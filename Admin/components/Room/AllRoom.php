...
<body>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">All Room</h1>
          </div>
          <div class="col-sm-6">
    ...
    <tbody>
        ...
        <?php
          ...
          $sql = "SELECT * FROM `status_bookroom` ORDER BY `ID` DESC";
            ...
            while ($d = mysqli_fetch_array($query)){
              ...
              echo "<tr>";
                ...
                if($d[7] == "Check In"){
                  ...
                  echo "<td><a class='btn btn-success btn-sm text-white' href='Server/CheckIn.php?idItemURL=$idItemURL'>Check In</button></td>";
                }
                if($d[7] == "Check Out"){
                    echo "<td>Check In</td>";
                  }else{
                    echo "<td><a class='btn btn-danger btn-sm text-white' href='Server/CheckOut.php?idItemURL=$idItemURL'>Check Out</button></td>";
                }
                echo "<td><a class='btn btn-danger btn-sm text-white' href='Server/Delete.php?idItemURL=$idItemURL'>Delete</button></td>";
              echo "</tr>";
            }
          }else{
